...
import { ArkErrorCode } from '../../../../src/core_cpp/common/ArkError';
import {
    ArkConditionExpr,
    ArkIfStmt,
    ArkReturnVoidStmt,
...
import { showCfgStmt, testBlocks } from '../../common';

describe('CfgTest', () => {
    it('case1: conditional operator', () => {
        const scene = buildScene('conditionalOperator');
        showCfgStmt(scene, 'conditionalOperatorSample.cpp', 'case1', CONDITIONAL_OPERATOR_EXPECT_CASE1.blocks);
