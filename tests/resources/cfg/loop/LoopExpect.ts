    ...
    blocks: [
        {
            ...
            stmts: [
                ...
                '%0.<@loop/LoopSample.ts: %AC0$%dflt-case2.a> = 1',
                '%0.<@loop/LoopSample.ts: %AC0$%dflt-case2.b> = 2',
                '%1 = new @loop/LoopSample.ts: %AC1$%dflt-case2',
                '%1 = instanceinvoke %1.<@loop/LoopSample.ts: %AC1$%dflt-case2.constructor()>()',
                '%1.<@loop/LoopSample.ts: %AC1$%dflt-case2.a> = 3',
                '%1.<@loop/LoopSample.ts: %AC1$%dflt-case2.b> = 4',
