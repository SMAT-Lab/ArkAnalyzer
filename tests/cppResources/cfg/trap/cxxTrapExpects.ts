...
export const TRAP_EXPECT_CASE1 = {
    blocks: [
        ...
        },
        {
            ...
            stmts: [
                'flag = false',
                '%0 = new @%unk/%unk: std::runtime_error',
                'instanceinvoke %0.<@%unk/%unk: std::runtime_error.constructor()>(\'zero\')',
                'throw <CXXFunctionalCastExpr: std::runtime_error>%0',
            ],
            preds: [1],
            succes: [3],
            exceptionalPreds: [],
    ...
    blocks: [
        ...
        },
        {
            ...
            stmts: [
                ...
                '%0 = staticinvoke <@%unk/%unk: .operator<<()>(cout, \'catch: \')',
                '%1 = instanceinvoke e.<@%unk/%unk: .what()>()',
