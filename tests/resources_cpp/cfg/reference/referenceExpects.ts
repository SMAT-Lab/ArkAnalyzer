    ...
    blocks: [
        {
            ...
            stmts: [
                ...
                'refA = 6',
                '%0 = new @%unk/%unk: basic_string<char>',
                'instanceinvoke %0.<@%unk/%unk: basic_string.constructor()>(\'Hello\')',
                'str1 = %0',
                '%1 = new @%unk/%unk: basic_string<char>',
                '%2 = staticinvoke <@%unk/%unk: .move()>(str1)',
                'instanceinvoke %1.<@%unk/%unk: basic_string.constructor()>(%2)',
                'str2 = %1',
                'return',
            ],
            preds: [],
