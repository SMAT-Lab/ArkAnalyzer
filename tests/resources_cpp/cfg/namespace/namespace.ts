                            ...
                            blocks: [
                                {
                                    ...
                                    stmts: [
                                        'this = this: @namespace/namespace.cpp: School.%AN0.%dflt',
                                        '%0 = staticinvoke <@%unk/%unk: .operator<<()>(cout, g_logPrefix)',
                                        '%1 = staticinvoke <@%unk/%unk: .operator<<()>(%0, \'Current counter value: \')',
                                        '%2 = staticinvoke <@%unk/%unk: .operator<<()>(%1, g_localCounter)',
                            ...
                            blocks: [
                                {
                                    ...
                                    stmts: [
                                        ...
                                        'g_localCounter = g_localCounter + 1',
                                        'return this',
                                    ],
                                    preds: [],
                                    succes: [],
                    ...
                    blocks: [
                        {
                            ...
                            stmts: [
                                ...
                                '%0 = new @%unk/%unk: std::string',
                                'instanceinvoke %0.<@%unk/%unk: std::string.constructor()>(\'[AnonymousSpace] \')',
                                'g_logPrefix = %0',
                                'g_localCounter = 0',
                                'return',
                            ],
