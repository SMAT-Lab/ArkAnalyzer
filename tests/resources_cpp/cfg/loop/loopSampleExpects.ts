    ...
    blocks: [
        {
            ...
            stmts: [
                ...
                '%2 = array (@loop/loopSample.cpp: Data[2])',
                '%2[0] = %0',
                '%2[1] = %1',
                'arr = %2',
                'i = 0',
...
export const LOOP_EXPECT_CASE8 = {
    blocks: [
        ...
        {
            id: 1,
            stmts: ['%6 = map1.<@std/map.h: map.end>', 'if %5 == %6'],
            preds: [0, 2],
            succes: [2, 3],
        },
        {
...
export const LOOP_EXPECT_CASE9 = {
    blocks: [
        ...
        {
            id: 1,
            stmts: ['%6 = map2.<@std/map.h: map.end>', 'if %5 == %6'],
            preds: [0, 2],
            succes: [2, 3],
        },
        {
    ...
    blocks: [
        {
            ...
            stmts: [
                ...
                '%2 = num.<@std/vector.h: vector.begin>',
            ],
            preds: [],
            succes: [1],
        },
        {
            id: 1,
            stmts: ['%3 = num.<@std/vector.h: vector.end>', 'if %2 == %3'],
            preds: [0, 2],
            succes: [2, 3],
        },
        {
