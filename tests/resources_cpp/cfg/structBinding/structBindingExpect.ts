    ...
    blocks: [
        {
            ...
            stmts: [
                ...
                '%0 = new @%unk/%unk: pair<int,int>',
                '%1 = staticinvoke <@%unk/%unk: .make_pair()>(1, 2)',
                'instanceinvoke %0.<@%unk/%unk: pair.constructor()>(%1)',
                'x = %0[0]',
                'y = %0[1]',
...
export const BINGING_EXPECT_MAP = {
    blocks: [
        ...
        {
            id: 1,
            stmts: ['%6 = scores.<@std/map.h: map.end>', 'if %5 == %6'],
            preds: [0, 2],
            succes: [2, 6],
        },
        {
        ...
        {
            id: 3,
            stmts: ['%9 = scores.<@std/map.h: map.end>', 'if %8 == %9'],
            preds: [6, 4],
            succes: [4, 5],
        },
        {
