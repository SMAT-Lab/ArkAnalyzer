...
export const SWITCH_EXPECT_CASE6 = {
    blocks: [
        {
            id: 0,
            stmts: ['this = this: @switch/switchSample.cpp: %dflt', 'a = 0', 'b = 1', 'a = a + 1'],
            preds: [],
            succes: [1],
        },
        { id: 1, stmts: ['a = ONE', 'return'], preds: [0], succes: [] },
    ],
};
...
export const SWITCH_EXPECT_CASE7 = {
    blocks: [
        ...
        { id: 1, stmts: [ 'b = TWO' ], preds: [ 0 ], succes: [ 2 ] },
        { id: 2, stmts: [ 'b = THREE' ], preds: [ 1, 5 ], succes: [ 4 ] },
        { id: 3, stmts: [ 'b = FOUR' ], preds: [ 6 ], succes: [ 4 ] },
        { id: 4, stmts: [ 'return' ], preds: [ 2, 3, 6 ], succes: [] },
        { id: 5, stmts: [ 'if a == THREE' ], preds: [ 0 ], succes: [ 2, 6 ] },
        { id: 6, stmts: [ 'if a == FOUR' ], preds: [ 5 ], succes: [ 3, 4 ] },
    ],
};
