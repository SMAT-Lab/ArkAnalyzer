...
export const SWITCH_EXPECT_CASE3 = {
    blocks: [
        ...
        { id: 2, stmts: ['if b == FOUR'], preds: [8], succes: [3, 9] },
        { id: 3, stmts: ['b = FOUR'], preds: [2], succes: [9] },
        { id: 4, stmts: ['b = FIVE'], preds: [9], succes: [5] },
        { id: 5, stmts: ['b = SIX'], preds: [4, 9], succes: [7] },
        ...
        { id: 9, stmts: ['if b == FIVE'], preds: [2, 3], succes: [4, 5] },
    ],
};
...
export const SWITCH_EXPECT_CASE11 = {
    blocks: [
        ...
        { id: 1, stmts: ['b = THREE'], preds: [3], succes: [2] },
