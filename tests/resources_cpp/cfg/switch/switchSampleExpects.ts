...
export const SWITCH_EXPECT_CASE1 = {
    blocks: [
        ...
        { id: 1, stmts: ['b = TWO'], preds: [0], succes: [5] },
...
export const SWITCH_EXPECT_CASE3 = {
    blocks: [
        ...
        { id: 1, stmts: ['b = TWO'], preds: [0], succes: [8] },
        { id: 2, stmts: ['if b == ONE'], preds: [8], succes: [3, 9] },
        { id: 3, stmts: ['b = ONE'], preds: [2], succes: [9] },
        { id: 4, stmts: ['b = TWO'], preds: [9], succes: [] },
        { id: 5, stmts: ['b = TEN'], preds: [9], succes: [7] },
        ...
        { id: 9, stmts: ['if b == TWO'], preds: [2, 3], succes: [4, 5] },
    ],
};
...
export const SWITCH_EXPECT_CASE4 = {
    blocks: [
        ...
        { id: 3, stmts: ['b = TWO'], preds: [2], succes: [9] },
        { id: 4, stmts: ['b = THREE'], preds: [9], succes: [8] },
...
export const SWITCH_EXPECT_CASE7 = {
    blocks: [
        ...
        { id: 1, stmts: ['b = TWO'], preds: [0], succes: [6] },
        { id: 2, stmts: ['b = THREE'], preds: [6], succes: [5] },
        { id: 3, stmts: ['b = FOUR'], preds: [7], succes: [] },
        { id: 4, stmts: ['b = TEN'], preds: [7], succes: [5] },
