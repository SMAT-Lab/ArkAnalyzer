    ...
    blocks: [
        {
            ...
            stmts: [
                ...
                'str1 = undefined',
                '%3 = &str1',
                'staticinvoke <@%unk/%unk: .napi_create_string_utf8()>(env, buf, 18446744073709551615, %3)',
                ...
                '%4 = &hello1',
                'staticinvoke <@%unk/%unk: .napi_create_string_utf8()>(env, \'world0\', 18446744073709551615, %4)',
