    ...
    blocks: [
        {
            ...
            stmts: [
                ...
                '%6 = new @%unk/%unk: std::pair<typename __unwrap_ref_decay<char ()[0]&,typename __unwrap_ref_decay<int >::type&>',
                '%7 = staticinvoke <@%unk/%unk: .make_pair()>(str1, num)',
                'instanceinvoke %6.<@%unk/%unk: std::pair.constructor()>(%7)',
        ...
        },
        {
            ...
            stmts: [
                ...
                'e = <unknown>%10',
                '%11 = e.<@%unk/%unk: .first>',
                '%12 = instanceinvoke %11.<@%unk/%unk: .c_str()>()',
                '%13 = e.<@%unk/%unk: .second>',
                'staticinvoke <@%unk/%unk: .printf()>(\'%s %d\\n\', %12, %13)',
