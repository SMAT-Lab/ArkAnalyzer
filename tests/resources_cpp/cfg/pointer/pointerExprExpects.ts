    ...
    blocks: [
        {
            ...
            stmts: [
                'this = this: @pointer/pointerExpr.cpp: %dflt',
                '%0 = new @%unk/%unk: std::unique_ptr<int>',
                '%1 = staticinvoke <@%unk/%unk: .make_unique()>(42)',
                'instanceinvoke %0.<@%unk/%unk: std::unique_ptr.constructor()>(%1)',
                'ptr1 = %0',
                '%2 = new @%unk/%unk: std::unique_ptr<int>',
                '%3 = new @%unk/%unk: int',
                'instanceinvoke %3.<@%unk/%unk: int.constructor()>(42)',
                'instanceinvoke %2.<@%unk/%unk: std::unique_ptr.constructor()>(%3)',
                'ptr2 = %2',
                '*ptr1 = 100',
                'rawPtr = instanceinvoke ptr1.<@%unk/%unk: std::unique_ptr.get()>()',
                'return',
            ],
            preds: [],
            succes: [],
    ...
    blocks: [
        {
            ...
            stmts: [
                'this = this: @pointer/pointerExpr.cpp: %dflt',
                '%0 = new @%unk/%unk: std::shared_ptr<int>',
                '%1 = staticinvoke <@%unk/%unk: .make_shared()>(42)',
                'instanceinvoke %0.<@%unk/%unk: std::shared_ptr.constructor()>(%1)',
                'ptr1 = %0',
                '%2 = new @%unk/%unk: std::shared_ptr<int>',
                '%3 = new @%unk/%unk: int',
                'instanceinvoke %3.<@%unk/%unk: int.constructor()>(42)',
                'instanceinvoke %2.<@%unk/%unk: std::shared_ptr.constructor()>(%3)',
                'ptr2 = %2',
                '*ptr1 = 100',
                'rawPtr = instanceinvoke ptr1.<@%unk/%unk: std::shared_ptr.get()>()',
                'return'
            ],
            preds: [],
            succes: [],
...
export const POINTER_EXPECT_CASE6 = {
    blocks: [
        ...
        },
        {
            id: 1,
            stmts: [
                '%0 = new @%unk/%unk: std::shared_ptr<@pointer/pointerExpr.cpp: Node>',
                '%1 = staticinvoke <@%unk/%unk: .make_shared()>(1)',
                'instanceinvoke %0.<@%unk/%unk: std::shared_ptr.constructor()>(%1)',
                'node1 = %0',
                '%2 = new @%unk/%unk: std::shared_ptr<@pointer/pointerExpr.cpp: Node>',
                '%3 = staticinvoke <@%unk/%unk: .make_shared()>(2)',
                'instanceinvoke %2.<@%unk/%unk: std::shared_ptr.constructor()>(%3)',
                'node2 = %2',
                'node1-><@%unk/%unk: std::shared_ptr.next> = node2',
                'node2-><@%unk/%unk: std::shared_ptr.parent> = node1',
                'return'
            ],
            preds: [0],
            succes: [],
