    ...
    blocks: [
        {
            ...
            stmts: [
                ...
                '%4 = new @%unk/%unk: std::vector<int><int>',
                ...
                '%7 = new @%unk/%unk: std::vector<int><int>',
    ...
    blocks: [
        {
            ...
            stmts: [
                'this = this: @dataStruct/dataStruct.cpp: %dflt',
                '%0 = new @%unk/%unk: std::map<int, std::basic_string<char>><int,string>',
                ...
                'map1 = %0',
                '%5 = new @%unk/%unk: std::basic_string<char><char>',
                '%6 = map1[1]',
                'instanceinvoke %5.<@%unk/%unk: std::basic_string<char>.constructor()>(%6)',
                'value1 = %5',
        ...
        },
        {
            id: 4,
            stmts: [
                '%12 = new @%unk/%unk: std::map<std::basic_string<char>, int><string,int>',
                'instanceinvoke %12.<@%unk/%unk: std::map<std::basic_string<char>, int>.constructor()>()',
                'map2 = %12',
                'map2[\'Alice\'] = 30',
                'map2[\'Bob\'] = 25',
                'map2[\'Charlie\'] = 35',
    ...
    blocks: [
        {
            ...
            stmts: [
                'this = this: @dataStruct/dataStruct.cpp: %dflt',
                '%0 = new @%unk/%unk: std::unordered_map<std::basic_string<char>, int><string,int>',
    ...
    blocks: [
        {
            ...
            stmts: [
                'this = this: @dataStruct/dataStruct.cpp: %dflt',
                '%0 = new @%unk/%unk: std::queue<int><int>',
        ...
        },
        {
            id: 2,
            stmts: [
                '%2 = new @%unk/%unk: std::vector<int><int>',
    ...
    blocks: [
        {
            ...
            stmts: [
                'this = this: @dataStruct/dataStruct.cpp: %dflt',
                '%0 = new @%unk/%unk: std::deque<int><int>',
    ...
    blocks: [
        {
            ...
            stmts: [
                'this = this: @dataStruct/dataStruct.cpp: %dflt',
                '%0 = new @%unk/%unk: std::stack<int><int>',
    ...
    blocks: [
        {
            ...
            stmts: [
                ...
                'list3 = %2',
                '%4 = new @%unk/%unk: std::list<int><int>',
