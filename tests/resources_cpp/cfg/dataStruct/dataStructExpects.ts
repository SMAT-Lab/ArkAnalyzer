    ...
    blocks: [
        {
            ...
            stmts: [
                ...
                '%1[3] = 4',
                '%1[4] = 5',
                'instanceinvoke %0.<@%unk/%unk: vector.constructor()>(%1)',
                'vec1 = %0',
                'men = vec1[2]',
    ...
    blocks: [
        {
            ...
            stmts: [
                'this = this: @dataStruct/dataStruct.cpp: %dflt',
                '%0 = new @%unk/%unk: set<int>',
                'instanceinvoke %0.<@%unk/%unk: set.constructor()>()',
                'set1 = %0',
                ...
                '%1 = new @%unk/%unk: set<int>',
                '%2 = instanceinvoke set1.<@std/set.h: set.begin()>()',
                '%3 = instanceinvoke set1.<@std/set.h: set.end()>()',
                'instanceinvoke %1.<@%unk/%unk: set.constructor()>(%2, %3)',
                'set2 = %1',
                'a = instanceinvoke set2.<@std/set.h: set.find()>(2)',
                '%4 = new @%unk/%unk: a',
                'instanceinvoke %4.<@%unk/%unk: a.constructor()>(a)',
                'instanceinvoke set2.<@std/set.h: set.erase()>(%4)',
                '%5 = new @%unk/%unk: set<int>',
                'instanceinvoke %5.<@%unk/%unk: set.constructor()>(set1)',
                'set3 = %5',
    ...
    blocks: [
        {
            ...
            stmts: [
                'this = this: @dataStruct/dataStruct.cpp: %dflt',
                '%0 = new @%unk/%unk: map<int,string>',
                '%1 = new @%unk/%unk: const std::pair<const int, std::basic_string<char>><int,string>',
                "instanceinvoke %1.<@%unk/%unk: const std::pair<const int, std::basic_string<char>>.constructor()>(1, 'one')",
                '%2 = new @%unk/%unk: const std::pair<const int, std::basic_string<char>><int,string>',
                "instanceinvoke %2.<@%unk/%unk: const std::pair<const int, std::basic_string<char>>.constructor()>(2, 'two')",
                '%3 = new @%unk/%unk: const std::pair<const int, std::basic_string<char>><int,string>',
                ...
                'map1 = %0',
                '%5 = new @%unk/%unk: basic_string<char>',
                '%6 = map1[1]',
                'instanceinvoke %5.<@%unk/%unk: basic_string.constructor()>(%6)',
                'value1 = %5',
    ...
    blocks: [
        {
            ...
            stmts: [
                'this = this: @dataStruct/dataStruct.cpp: %dflt',
                '%0 = new @%unk/%unk: unordered_map<string,int>',
                'instanceinvoke %0.<@%unk/%unk: unordered_map.constructor()>()',
                'myMap = %0',
                "myMap['apple'] = 10",
                '%1 = new @%unk/%unk: pair<typename __unwrap_ref_decay<const char (&)[7]>::type, typename __unwrap_ref_decay<int>::type><char ()&[],int>',
                "%2 = staticinvoke <@%unk/%unk: .make_pair()>('banana', 20)",
                'instanceinvoke %1.<@%unk/%unk: pair<typename __unwrap_ref_decay<const char (&)[7]>::type, typename __unwrap_ref_decay<int>::type>.constructor()>(%2)',
    ...
    blocks: [
        {
            ...
            stmts: [
                'this = this: @dataStruct/dataStruct.cpp: %dflt',
                '%0 = new @%unk/%unk: deque<int>',
                'instanceinvoke %0.<@%unk/%unk: deque.constructor()>()',
                'dq = %0',
    ...
    blocks: [
        {
            ...
            stmts: [
                'this = this: @dataStruct/dataStruct.cpp: %dflt',
                '%0 = new @%unk/%unk: list<int>',
                'instanceinvoke %0.<@%unk/%unk: list.constructor()>(5)',
                'list1 = %0',
                '%1 = new @%unk/%unk: list<int>',
                'instanceinvoke %1.<@%unk/%unk: list.constructor()>(5, 10)',
                'list2 = %1',
                '%2 = new @%unk/%unk: list<int>',
                '%3 = newarray (int[])[4]',
                '%3[0] = 1',
                '%3[1] = 2',
                '%3[2] = 3',
                '%3[3] = 4',
                'instanceinvoke %2.<@%unk/%unk: list.constructor()>(%3)',
                'list3 = %2',
                '%4 = new @%unk/%unk: list<int>',
