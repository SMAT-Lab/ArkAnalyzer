    ...
    blocks: [
        {
            ...
            stmts: [
                ...
                'instanceinvoke %4.<@%unk/%unk: std::vector.constructor()>()',
                'vec2 = %4',
                ...
                'instanceinvoke %7.<@%unk/%unk: std::vector.constructor()>()',
                'vec3 = %7',
...
export const DATA_STRUCT_EXPECT_MAP = {
    blocks: [
        ...
        },
        {
            id: 4,
            stmts: [
                '%12 = new @%unk/%unk: std::map<string,int>',
                'instanceinvoke %12.<@%unk/%unk: std::map.constructor()>()',
                'map2 = %12',
                "map2['Alice'] = 30",
                "map2['Bob'] = 25",
                "map2['Charlie'] = 35",
    ...
    blocks: [
        ...
        },
        {
            ...
            stmts: [
                ...
                'instanceinvoke %2.<@%unk/%unk: std::vector.constructor()>()',
                'v = %2'
            ],
            preds: [0, 1],
            succes: [3],
