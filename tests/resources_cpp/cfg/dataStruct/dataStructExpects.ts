    ...
    blocks: [
        {
            ...
            stmts: [
                ...
                '%4 = new @%unk/%unk: std::_Tree_const_iterator<std::_Tree_val<std::_Tree_simple_types<int>>>',
                'instanceinvoke %4.<@%unk/%unk: std::_Tree_const_iterator.constructor()>(a)',
    ...
    blocks: [
        {
            ...
            stmts: [
                ...
                'myMap = %0',
                'myMap[\'apple\'] = 10',
                '%1 = new @%unk/%unk: std::pair<char*,int>',
                ...
                '%5 = new @%unk/%unk: std::basic_string<char>',
                'instanceinvoke %5.<@%unk/%unk: std::basic_string.constructor()>(\'banana\')',
                '%6 = instanceinvoke myMap.<@%unk/%unk: std::unordered_map.at()>(%5)',
                '%7 = staticinvoke <@%unk/%unk: .operator<<()>(cout, %6)',
                'staticinvoke <@%unk/%unk: .operator<<()>(%7, endl)',
                '%8 = new @%unk/%unk: std::basic_string<char>',
                'instanceinvoke %8.<@%unk/%unk: std::basic_string.constructor()>(\'orange\')',
        ...
        },
        {
            id: 1,
            stmts: [
                '%11 = new @%unk/%unk: std::basic_string<char>',
                'instanceinvoke %11.<@%unk/%unk: std::basic_string.constructor()>(\'apple\')',
